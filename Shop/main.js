...
function genItem(typ, title, size, laufnummer, JSON){
    ...
    var content =  '<div class="item" id="item'+laufnummer+'" onclick="addToCart('+typ+","+laufnummer+')"><div class="desc"><p>'+title+
    '</p><p>'+size+'</p></div><img src="res/thumb/'+icon+'"><div class="plus"><span>&#65291;</span></div></div>';
    return content;
}
...
function showCartTable(){
    if (sessionStorage.getItem('shopping-cart')) {
        ...
        for(i=0; i<cartArr.length; i++){
            ...
            var nr = i+1
            $("#cartItems").append("<div class='cartItem'><div class='tc'>"+nr+"</div><div class='tc'>"+product+"</div><div class='tc'>"+size+"</div><div class='rem' onclick='removeItem("+i+")'>&#x2715</div></div></div>");
        }
	}
